...
export const materiali: Materiale[] = [
  {
    ...
    scortaMinima: 1.0,
    giacenzaAttuale: 2.4,
    note: "Filamento standard per prototipi e uso interno.",
  },
  {
    id: "mat-002",
    ...
    scortaMinima: 1.0,
    giacenzaAttuale: 0.3,
    note: "Sotto scorta — riordinare al prossimo ordine.",
  },
  {
    id: "mat-003",
    nome: "Resina trasparente",
    categoria: "primario",
    tipoMateriale: "resina",
    marca: "Anycubic",
    colore: "Trasparente",
    unitaMisura: "L",
    costoUnitario: 45.0,
  ...
  },
  {
    ...
    scortaMinima: 1.0,
    giacenzaAttuale: 2.4,
    note: "Pulizia piatti e post-processing SLA.",
  },
  {
    id: "mat-005",
    nome: "Ugello 0.4mm",
    ...
    note: "Ricambio hotend Prusa MK4.",
  },
];

export const lotti: Lotto[] = [
  {
    id: "lot-001",
    materialeId: "mat-001",
    numeroLotto: "PLA-N-2604",
    fornitore: "Store ufficiale FilamentiPro",
    quantitaIniziale: 3.0,
    giacenzaAttuale: 2.4,
    costoLotto: 66.0,
    dataAcquisto: "12/04/2026",
  },
  {
    id: "lot-002",
    materialeId: "mat-002",
    numeroLotto: "",
    fornitore: "Amazon",
    quantitaIniziale: 2.0,
    giacenzaAttuale: 0.3,
    costoLotto: 56.0,
    dataAcquisto: "02/03/2026",
    dataScadenza: "02/03/2027",
  },
  {
    id: "lot-003",
    materialeId: "mat-003",
    numeroLotto: "RES-CL-118",
    fornitore: "Store ufficiale Anycubic",
    quantitaIniziale: 1.5,
    giacenzaAttuale: 1.2,
    costoLotto: 67.5,
    dataAcquisto: "20/05/2026",
    dataScadenza: "20/05/2027",
  },
  {
    id: "lot-004",
    materialeId: "mat-004",
    numeroLotto: "",
    fornitore: "Farmacia locale",
    quantitaIniziale: 3.0,
    giacenzaAttuale: 2.4,
    costoLotto: 25.5,
...
export const movimenti: Movimento[] = [
  {
    ...
    commessaId: null,
    data: "12/04/2026",
    note: "Ingresso lotto PLA-N-2604",
  },
  {
    id: "mov-002",
    materialeId: "mat-001",
  ...
  },
  {
    ...
    commessaId: "com-001",
    data: "22/05/2026",
    note: "Prove PETG per segnaletica",
  },
  {
    id: "mov-005",
    materialeId: "mat-002",
